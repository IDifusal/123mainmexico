            ...
            <div class="offcanvas__content">
                <div class="offcanvas__top d-flex justify-content-between align-items-center">
                    <div class="offcanvas__logo">
                        <nuxt-link to="/">
                            <img src="https://html.rrdevs.net/delish/assets/imgs/logo/logo.svg" alt="logo not found">
                        </nuxt-link>
                    </div>
                ...
                <div class="offcanvas__btn">
                    <div class="header__btn-wrap">
                        ...
                        <a href="https://themeforest.net/user/rrdevs/portfolio" class="rr-btn__header w-100">
                            ...
                            <span class="fake_hover"></span>
                            <span class="btn-wrap">
                                <span class="text-one">Purchase Now <img src="https://html.rrdevs.net/delish/assets/imgs/icon/arrow-right.svg" alt="not found"></span>
                                <span class="text-two">Purchase Now <img src="https://html.rrdevs.net/delish/assets/imgs/icon/arrow-right.svg" alt="not found"></span>
                            </span>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="col-xxl-6 col-8">
                        <div class="last_no_bullet">
                            <ul class="header__top-menu d-flex justify-content-end">
                                <li><a href="mailto:reservations@delish.com">reservations@123mainmexico.com</a></li>
                                <li><a href="tel:1234567899">123 456 7899</a></li>
                                <li><a href="https://maps.app.goo.gl/V5BeTXNv6WAniBN58">296 Ridao Avenie Mor Berlin 251584</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="mega__menu-wrapper p-relative">
                <div class="header__main">
                    <div class="header__logo">
                        <nuxt-link to="/">
                            <div class="logo">
                                <img src="https://123mainmexico.com/wp-content/uploads/2024/06/Recurso-1.png" alt="123 Main Mexico" width="150">
                            </div>
                        </nuxt-link>
                    </div>
                    ...
                    <div class="header__right">
                        <div class="header__action d-flex align-items-center">
                            <div class="header__btn-wrap d-none d-sm-inline-flex">
                                <nuxt-link to="/reservation" class="rr-btn__header">
                                    <span class="hover-rl"></span>
                                    <span class="fake_hover"></span>
                                    <span class="btn-wrap">
                                        <span class="text-one">Book A Table <img src="https://html.rrdevs.net/delish/assets/imgs/icon/arrow-right.svg" alt="not found"></span>
