<template>
    <main>
        ...
        <section class="about-2 section-space overflow-hidden">
            <div class="container">
                <div class="about-2__shape">
                    <img src="https://html.rrdevs.net/delish/https://html.rrdevs.net/delish/assets/imgs/about-2/burger.png"
                        class="img-fluid leftRight" alt="not found">
                </div>
                <div class="row g-24 align-items-center">
                        ...
                        <div class="about-2__content">
                            <div class="section__title-wrapper text-start mb-35 mb-xs-40">
                                <span
                                    ...
                                    123 Main Mexico</span>
                                <h2 class="section__title mb-0 title-animation">Authentic Mexican Flavors, Vibrant
                                    Atmosphere</h2>
                            </div>
                            ...
                            <div class="about-2__content-item__wrapper mb-40">
                                <div class="about-2__content-item mb-35">
                                    ...
                                    <div class="about-2__content-item__text">
                                        ...
                                        <p class="mb-0">Experience the finest, freshest ingredients in every dish at 123
                                            Main Mexico.</p>
                                    </div>
                                </div>
                                <div class="about-2__content-item mb-35">
                    ...
                    <div class="col-xl-6">
                        <div class="about-2__media wow clip-a-z">
                            <img src="/images/Best-Mexican-Restoruant-in-Pineville.png" class="img-fluid"
                                alt="image not found">
                        </div>
                    </div>
                </div>
        ...
        <!--  food-gallery-->
        <section class="food-gallery section-space section-bg-4"
            data-background="https://html.rrdevs.net/delish/assets/imgs/food-gallery/bg.png">
            <div class="container">
                <div class="row g-24">
                    <div class="col-12">
                        <div class="section__title-wrapper text-center mb-70 mb-sm-50 mb-xs-40">
                            <span class="section__subtitle justify-content-center mb-10 mb-xs-5 wow clip-a-z">Food
                                Gallery</span>
                            ...
                            <div class="dot-shpae wow clip-a-z">
                                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="61" viewBox="0 0 48 61"
                                    fill="#163965">
                                    <rect y="56" width="6" height="6" transform="rotate(-45 0 56)" fill="#163965" />
                                    <rect x="13" y="56" width="6" height="6" transform="rotate(-45 13 56)"
                                        fill="#163965" />
                                    <rect x="26" y="56" width="6" height="6" transform="rotate(-45 26 56)"
                                        fill="#163965" />
                                    <rect x="39" y="56" width="6" height="6" transform="rotate(-45 39 56)"
                                        fill="#163965" />
                ...
                <div class="row g-24 mb-minus-24">
                    <div v-for="(image, index) in images" :key="index" class="col-lg-4 col-md-6">
                        <div class="food-gallery__item mb-24">
                            <div class="food-gallery__item-media">
                                <img :src="image.src" :alt="image.alt" @click="openLightbox(image.src)" />
                            </div>
                            <div class="food-gallery__item-hover">
                                <a href="javascript:void(0)" class="food-gallery__item-hover-icon"
